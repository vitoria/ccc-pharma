  ...
  onSuccess = event => {
    ...
    if (name === '' || email === '' || password === '' || passwordConfirmation === '') {
      ...
      if (password === passwordConfirmation) {
        createUser({ name, email, password, role: 'CLIENT' }).then(response => {
  ...
  render() {
    ...
    return (
      <form onSubmit={e => this.onSuccess(e)}>
        ...
        <input type="text" id="nameClient" value={name} onChange={e => this.handleNameChange(e)}></input>
        <label htmlFor="emailClient">E-mail</label>
        <input type="email" id="emailClient" value={email} onChange={e => this.handleUsernameChange(e)}></input>
        <label htmlFor="passwordClient">Senha</label>
        <input type="password" id="passwordClient" value={password} onChange={e => this.handlePasswordChange(e)}></input>
        <label htmlFor="passwordConfirmationClient">Confirmar Senha</label>
        <input type="password" id="passwordConfirmationClient" value={passwordConfirmation} onChange={e => this.handlePasswordConfirmationChange(e)}></input>
        {error && (
